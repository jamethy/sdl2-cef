...
KeyCodes getAlphabetCodes(SDL_Keycode code, Modifiers &modifiers) {
...
KeyCodes getNumberRowCodes(SDL_Keycode code, Modifiers &modifiers) {
...
KeyCodes getFunctionKeyCodes(SDL_Keycode code) {
...
KeyCodes getSpecialKeyCodes(SDL_Keycode code, Modifiers &modifiers) {
...
void handleWindowEvent(SDL_Event &e, CefBrowser *browser) {
